class OffersController < ApplicationController
  ...
  def update
    if @offer.update(offer_params)
      @offer.project = relationship_params[:project] if elationship_params[:project]
      @offer.contacts = relationship_params[:contacts] elationship_params[:contacts]
      @offer.tasks = relationship_params[:tasks] elationship_params[:tasks]
